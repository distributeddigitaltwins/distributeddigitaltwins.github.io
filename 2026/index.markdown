...
It uses pervasive Internet of Things (IoT) technologies, such as sensors and actuators.
...
The second edition of DiDiT will be organized in a hybrid format, enabling both on-site and remote participation.
It will feature a panel discussion with renowned experts from academia and industry, focusing on the overarching challenge of building sustainable Digital Twin ecosystems for intelligent environments.
In particular, the panel will explore how such ecosystems can remain viable and effective over time when involving multiple stakeholders, diverse objectives, and federated services at scale (e.g., city-level Digital Twins).

Key discussion themes will include:
* _The convergence of Digital Twins and AI_, examining how advanced AI techniques can enhance modeling, prediction, and autonomous decision-making within large-scale ecosystems.
* _Collaborative AI_, addressing how multiple intelligent agents and interconnected Digital Twins can coordinate effectively in shared environments.
* _From pilot to platform_, analyzing how experimental prototypes can be transformed into robust, operational systems deployed at scale.
* _Governance, federation, and long-term sustainability_, focusing on organizational, technical, and societal mechanisms needed to ensure the longevity of complex, multi-actor Digital Twin ecosystems serving large populations of users.
...
* Distributed digital twins properties, definitions, modelling, verification, and validation
* Management and orchestration of distributed control systems
* Representation models and decision-making with digital twins
* Evolutionary frameworks for cyber-physical systems
* Real-world deployments and experimentations
* Sustainable and circular digital twins
...
### Submission system
[https://easychair.org/conferences/?conf=didit2026](https://easychair.org/conferences/?conf=didit2026)
